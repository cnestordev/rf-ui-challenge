...
const Main = () => {
    return (
        <div className='main-container'>
            ...
            <div className='step-container'>
                <h3 className='step-title'><span>Step 2:</span> Build registration workflows.</h3>
                ...
                <div className='step-container'>
                <h3 className='step-title'><span>Step 3:</span> Design post-registration experiences.</h3>
                <div className='step-border no-border'>
                    <Card 
